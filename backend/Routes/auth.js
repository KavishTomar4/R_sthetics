...
router.post('/register', async(req, res)=>{
    ...
    try{
        ...
        res.cookie('rs_client', token, {maxAge: 30*24*60*60, httpOnly: false, secure: false, sameSite: 'none'});
...
router.get('/logout', (req, res)=>{
    res.cookie('rs_client', '', {maxAge: 1, httpOnly: false, secure: false, sameSite: 'none'});
    res.json({toLink: '/'})
})
